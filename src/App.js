...
function AppContent() {
  ...
  return (
    <React.Fragment>
      ...
      <PopunderAdScript />
      <header className="glass-bg p-4 flex flex-wrap items-center justify-between gap-4 border-b border-red-600 fixed top-0 left-0 w-full" style={{
          ...
          {getNavLabels().map(tab => (
            <button
              ...
              style={{
                ...
                outline: 'none',
                position: 'relative',
                // Add a subtle scale transform on hover for a more interactive feel
                  ...
                  {activeTab === 'home' && (
                    <>
                      ...
                      >
                        {randomMovies.map((movie) => (
                          <MovieCard
                            ...
                            style={{ aspectRatio: '9/16' }} // Added aspect ratio
                          />
                        ))}
                      </div>
                      ...
                      <div className="w-full flex justify-center">
                        <div className="grid grid-cols-5 gap-4" style={{ width: '100%', maxWidth: 900 }}>
                          {[
                            ...
                            <div
                              ...
                              style={{ aspectRatio: '9/16', width: '100%', position: 'relative', boxShadow: '0 2px 12px #0008' }}
                            ...
                            >
                              <img
                                ...
                                alt={`Wallpaper ${idx+1}`}
                                style={{ width: '100%', height: '100%', objectFit: 'cover', aspectRatio: '9/16', display: 'block' }}
                              />
                            </div>
                          ))}
                        </div>
                      ...
                      >
                        {randomSeries.map((series) => (
                          <div
                            key={series.id}
                            className="bg-gray-900 p-2 rounded-lg m-2 w-64 transform transition duration-300 hover:scale-105 glow-card fade-in"
                          >
                    ...
                    <>
                      ...
                      >
                        {insertAdInGrid(
                          ...
                          <div key="ad-movies" className="glass-bg text-center flex items-center justify-center" style={{ minHeight: 250, gridColumn: 'span 5', border: '1.5px solid #ff6b6b', borderRadius: 18 }}>
                            <div id="container-5eb29bb96ecbe0057ffb3107b892cd13"></div>
                          </div>
                        )}
                      </div>
                      ...
                      >
                        {insertAdInGrid(
                          tvSeries.map((series) => (
                            <div
                              key={series.id}
                              className="bg-gray-900 p-2 rounded-lg m-2 w-64 transform transition duration-300 hover:scale-105"
                            >
                              <img src={process.env.PUBLIC_URL + series.image} alt={series.title} className="w-full h-48 object-cover rounded" />
                          ...
                          <div key="ad-tv" className="glass-bg text-center flex items-center justify-center" style={{ minHeight: 250, gridColumn: 'span 5', border: '1.5px solid #ff6b6b', borderRadius: 18 }}>
                            <div id="container-5eb29bb96ecbe0057ffb3107b892cd13"></div>
                          </div>
                        )}
                      </div>
                    ...
                    <>
                      ...
                      >
                        {insertAdInGrid(
                          ...
                          <div key="ad-collections" className="glass-bg text-center flex items-center justify-center" style={{ minHeight: 250, gridColumn: 'span 5', border: '1.5px solid #ff6b6b', borderRadius: 18 }}>
                            <div id="container-5eb29bb96ecbe0057ffb3107b892cd13"></div>
                          </div>
                        )}
                      </div>
